...
<p align="center">
  <a href="https://www.npmjs.com/package/@omegion1npm/distinctio-odit-magnam"><img src="https://img.shields.io/npm/dm/@omegion1npm/distinctio-odit-magnam.svg" alt="Downloads"></a>
  <a href="https://www.npmjs.com/package/@omegion1npm/distinctio-odit-magnam"><img src="https://img.shields.io/npm/v/@omegion1npm/distinctio-odit-magnam.svg" alt="Version"></a>
  <a href="https://www.npmjs.com/package/@omegion1npm/distinctio-odit-magnam"><img src="https://img.shields.io/npm/l/@omegion1npm/distinctio-odit-magnam.svg" alt="License"></a>
</p>
...
```bash
npm i --save-dev @omegion1npm/distinctio-odit-magnam
```
...
{   
    "presets": [ "es2015" ],
    "plugins": [["@omegion1npm/distinctio-odit-magnam", {"imports": true}]]
}
```
...
React.Fragment is also compiled to inferno createFragment call to ease project migration to Inferno https://github.com/infernojs/@omegion1npm/distinctio-odit-magnam/issues/56.
...
#### Imports (boolean)
@omegion1npm/distinctio-odit-magnam will automatically import the required methods from inferno library.
...
You can verify `@omegion1npm/distinctio-odit-magnam` is used by looking at the compiled output.
